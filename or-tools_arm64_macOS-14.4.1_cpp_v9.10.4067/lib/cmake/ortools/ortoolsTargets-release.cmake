...
set_target_properties(ortools::ortools PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libortools.9.10.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libortools.9.dylib"
  )

list(APPEND _cmake_import_check_targets ortools::ortools )
list(APPEND _cmake_import_check_files_for_ortools::ortools "${_IMPORT_PREFIX}/lib/libortools.9.10.dylib" )
...
set_target_properties(ortools::flatzinc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libortools_flatzinc.9.10.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libortools_flatzinc.9.dylib"
  )

list(APPEND _cmake_import_check_targets ortools::flatzinc )
list(APPEND _cmake_import_check_files_for_ortools::flatzinc "${_IMPORT_PREFIX}/lib/libortools_flatzinc.9.10.dylib" )
